...
{
    Console.Write("Точка лежит в второй четверти");
}
else if(x < 0 && y < 0)
{
...
double res = Math.Pow(number, 2); // производит возведение в степень
System.Console.WriteLine(res);


double res = Math.Sqrt(number); // извлекать квадратный корень от числа
